package com.hitqz.disinfectionrobot.widget.editspinner;
...
public class EditSpinner extends RelativeLayout implements View.OnClickListener, AdapterView.OnItemClickListener, TextWatcher {
    ...
    private void initView(AttributeSet attrs) {
        ...
        editText.setEnabled(tArray.getBoolean(R.styleable.EditSpinner_editable, true));
    ...
    public final void afterTextChanged(Editable s) {
        ...
        if (!TextUtils.isEmpty(key) && !isInitData) {
            showFilterData(key);
        } else {
            isInitData = false;
            if (popupWindow != null) {
